...
def create_fixed_web_form_workflow():
    """Create a fixed web form integration workflow that matches the Google Sheet structure."""
    
    # Define the workflow
    workflow = {
        "name": "BLKOUT NXT Web Form Integration (Fixed)",
        "nodes": [
            {
                "parameters": {
                    "httpMethod": "POST",
                    "path": "blkout-nxt-signup-fixed",
                    "options": {
...
return memberData;"""
    ...
    try:
        ...
        print(f"Webhook URL: http://localhost:5678/webhook/blkout-nxt-signup-fixed")
...
if __name__ == "__main__":
    workflow_id = create_fixed_web_form_workflow()
