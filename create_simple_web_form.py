...
def create_web_form_workflow():
    ...
    nodes = [
        # Webhook node
        {
            ...
            "typeVersion": 1,
            "position": [0, 0],
            "webhookId": "blkout-nxt-signup-simple"
        },
    ...
    # Create the workflow
    workflow_name = "BLKOUT NXT Web Form Integration (Simple)"
    ...
    if result:
        ...
        if activate_result:
            ...
            config["n8n"]["simple_web_form_workflow_id"] = result["id"]
