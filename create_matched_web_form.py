...
def create_matched_web_form_workflow():
    """Create a web form integration workflow that matches the Google Sheet structure."""
    
    # Define the workflow
    workflow = {
        "name": "BLKOUT NXT Web Form Integration (Matched)",
        "nodes": [
            {
                "parameters": {
                    "httpMethod": "POST",
                    "path": "blkout-nxt-signup-matched",
                    "options": {
...
return memberData;"""
    ...
    try:
        ...
        print(f"Webhook URL: http://localhost:5678/webhook/blkout-nxt-signup-matched")
...
if __name__ == "__main__":
    workflow_id = create_matched_web_form_workflow()
