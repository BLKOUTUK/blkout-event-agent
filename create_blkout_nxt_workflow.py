...
print("Creating BLKOUT NXT Onboarding workflow with segmentation...")
...
# Load the BLKOUT NXT onboarding workflow
with open("blkout_nxt_onboarding_workflow.json", "r") as f:
